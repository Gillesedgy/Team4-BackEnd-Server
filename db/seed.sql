...
(14, 'Estudio para personas de bajos ingresos en Brooklyn. Cerca del transporte público y servicios locales.', 'Spanish', '{"https://dummyimage.com/400x400/6e6c6e/e9e9f5.png&text=No+Image"}', '2023-05-03', 900.00, '86 South ', FALSE, FALSE, 'Estudio en Brooklyn.', NULL, 0),
...
(17, 'ترجمة الجملة إلى العربية: "شقة بغرفتي نوم واسعة في برونكس للعائلات ذات الدخل المنخفض. تم تجديدها ', 'Arabic', '{"https://dummyimage.com/400x400/6e6c6e/e9e9f5.png&text=No+Image"}', '2023-05-06', 1500.00, '', FALSE, FALSE, 'مؤخرًا بواسطة أجهزة جديدة. شقة بغرفتي نوم في برونكس', NULL, 2),
